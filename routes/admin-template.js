...
module.exports = function(app) {
  ...
  app.get('/admin-template', function (req, res) {
    // get query string
                      ...
                      if(result) {
                        ...
                        dbClient.query('SELECT * from day', function (err, result) {
                          ...
                          if(result) {
                            ...
                            return res.render('admin-template.pug', {message: message, login: "Logout", codes: codes, blocks: blocks, blocks2: JSON.stringify(blocks), chairs: chairs, sequence: sequence, sequences2: JSON.stringify(sequence), days: days, days2: JSON.stringify(days)} );
